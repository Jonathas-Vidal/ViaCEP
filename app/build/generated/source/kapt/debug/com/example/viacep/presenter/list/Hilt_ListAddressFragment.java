 ...
 */
public abstract class Hilt_ListAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListAddressFragment() {
    super();
  }

  Hilt_ListAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListAddressFragment_GeneratedInjector) this.generatedComponent()).injectListAddressFragment(UnsafeCasts.<ListAddressFragment>unsafeCast(this));
    }
  }

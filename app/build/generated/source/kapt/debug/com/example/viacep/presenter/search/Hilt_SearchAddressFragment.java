 ...
 */
public abstract class Hilt_SearchAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchAddressFragment() {
    super();
  }

  Hilt_SearchAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchAddressFragment_GeneratedInjector) this.generatedComponent()).injectSearchAddressFragment(UnsafeCasts.<SearchAddressFragment>unsafeCast(this));
    }
  }
